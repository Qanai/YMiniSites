<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="YMiniSites.Purim2016.Default" %>

<%@ Register Src="UC/AppForm.ascx" TagName="AppForm" TagPrefix="uc1" %>

<%@ Register Src="UC/AppGalleryControl.ascx" TagName="GalleryControl" TagPrefix="uc2" %>
...
<head runat="server">
    ...
    <link href="Style/AppForm.css" rel="stylesheet" />
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <uc2:GalleryControl ID="GalleryControl1" runat="server" />
